            ...
            <Head
                title={
                    company.data.length > 0
                        ? `My Company (${company.data.length})`
                        : "No company"
                }
            />
            <div className="min-h-screen bg-gray-50">
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="flex justify-between items-center mb-6">
                        <h1 className="text-3xl font-bold xs-range:text-sm xs-s-range:text-sm">
                            My Companies
                        </h1>
                        <Dialog
                            open={dialogOpen}
                        ...
                        >
                            ...
                            <DialogContent className="sm:max-w-[500px] xs-range:max-w-[400px] xs-s-range:max-w-[400px]:">
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Choose which company you want to add a
                                        new car to.
                                    </DialogDescription>
                                </DialogHeader>
                    ...
                    {company.data.length === 0 && (
                        <div className="text-center py-10">
                            <p className="text-muted-foreground">
                                You don't have any companies yet. Add your first
                                company!
                            </p>
                        </div>
                    )}
